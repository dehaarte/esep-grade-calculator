...
func TestGradeType(t *testing.T) {
	if Assignment.String() != "assignment" {
		t.Errorf("Expected Assignment to return 'assignment'; got '%s' instead", Assignment.String())
	}
	if Exam.String() != "exam" {
		t.Errorf("Expected Exam to return 'exam'; got '%s' instead", Exam.String())
	}
	if Essay.String() != "essay" {
		t.Errorf("Expected Essay to return 'essay'; got '%s' instead", Essay.String())
	}
}